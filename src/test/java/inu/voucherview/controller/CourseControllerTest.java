...
class CourseControllerTest {
    ...
    void getAllCourses_Success() throws Exception {
        ...
        courseList.add(new CourseDto(Course.of(1L, 1L)));
        courseList.add(new CourseDto(Course.of(2L, 1L)));
        courseList.add(new CourseDto(Course.of(3L, 2L)));
    ...
    void getAllCourses_EmptyList() throws Exception {
        // Given
        List<CourseDto> emptyList = new ArrayList<>();
        Pagination pagination = new Pagination(1, 10, 0);
    ...
    void getCourseById_Success() throws Exception {
        // Given
        Long courseId = 1L;
        CourseDto courseDto = new CourseDto(Course.of(courseId, 1L));
    ...
    void getAllCourses_Pagination() throws Exception {
        ...
        List<CourseDto> courseList = new ArrayList<>();
        for (int i = 1; i <= 5; i++) {
            courseList.add(new CourseDto(Course.of((long) i, 1L)));
        }
